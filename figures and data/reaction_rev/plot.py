...
ax[0].plot(fpr1[:,0]*10**-6, fpr1[:,1], linestyle=linestyles['densely dashdotdotted'], label='NERDSS', color = 'tab:red')
...
axins.plot(fpr1[:,0]*10**-6, fpr1[:,1], linestyle=linestyles['densely dashdotdotted'], label='NERDSS', color = 'tab:red')
...
ax[1].plot(fpr2[1:-1,0], fpr2[1:-1,1], linestyle=linestyles['densely dashdotdotted'], label='NERDSS', color = 'tab:red')
...
ax[2].plot(fpr3[:,0]*1e-6, fpr3[:,1], linestyle=linestyles['densely dashdotdotted'], label='NERDSS', color = 'tab:red')
...
axins.plot(fpr3[:,0]*1e-6, fpr3[:,1], linestyle=linestyles['densely dashdotdotted'], label='NERDSS', color = 'tab:red')
