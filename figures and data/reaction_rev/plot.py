...
fpr2 = np.loadtxt('ReversibleBinding2D/FPR_shortAndLong_mean5traj_rev2d.txt')
...
ax[0].plot(fpr1[:,0]*10**-6, fpr1[:,1], linestyle=linestyles['densely dashdotdotted'], label='FPR')
...
axins.plot(fpr1[:,0]*10**-6, fpr1[:,1], linestyle=linestyles['densely dashdotdotted'], label='FPR')
...
ax[1].plot(fpr2[1:-1,0], fpr2[1:-1,1], linestyle=linestyles['densely dashdotdotted'], label='FPR')
...
ax[2].plot(fpr3[:,0], fpr3[:,1], linestyle=linestyles['densely dashdotdotted'], label='FPR')
ax[2].plot(ssa3[:,0], ssa3[:,1], ':', label='Gillespie')
ax[2].plot(smoldyn3[:,0], smoldyn3[:,1], linestyle=linestyles['densely dashed'], label='Smoldyn')
ax[2].set_xscale('log')
...
axins.plot(fpr3[:,0], fpr3[:,1], linestyle=linestyles['densely dashdotdotted'], label='FPR')
axins.plot(ssa3[:,0], ssa3[:,1], ':', label='Gillespie')
axins.plot(smoldyn3[:,0], smoldyn3[:,1], linestyle=linestyles['densely dashed'], label='Smoldyn')
axins.set_xscale('log')
