...
ax.plot(fpr_mem[:,0], fpr_mem[:,1], linestyle=linestyles['densely dashdotdotted'], label='FPR', color = 'tab:red')
...
axins.plot(fpr_mem[:,0], fpr_mem[:,1], linestyle=linestyles['densely dashdotdotted'], label='FPR', color = 'tab:red')
